...
from common.wrappers import ShareSubprocVecEnv, ShareDummyVecEnv, ShareEnv, SafeNormalizeObservation, MultiGoalEnv
...
from common.saute_env import SauteEnv
...
def main(args, cfg_env=None):
    ...
    for epoch in range(epochs):
        ...
        for steps in range(local_steps_per_epoch):
            ...
            true_reward = info.get("true_reward", info.get("final_info", {}).get("true_reward", 0.0))
            ep_ret += true_reward
            ep_cost += cost
            ep_len += 1
