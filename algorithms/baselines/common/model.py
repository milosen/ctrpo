...
def build_mlp_network(sizes, activation=nn.Tanh):
    """
...
class RNDActorVCritic(nn.Module):
    """
    ...
    def __init__(self, obs_dim, act_dim, hidden_sizes: list = [64, 64]):
        ...
        self.exp_critic = VCritic(obs_dim, hidden_sizes)
    ...
    def step(self, obs, deterministic=False):
        ...
        value_e = self.exp_critic(obs)
        value_c = self.cost_critic(obs)
        return action, log_prob, value_r, value_e, value_c
